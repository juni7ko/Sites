	...
	<div class="row">
		<div class="container">
			<div class="main-slide-gallery">
				<img src="<?=$g4['path']?>/layout/images/ex_pension.jpg" alt="" />
...
<div id="section" class="section2">	
	<div class="row">
		<div class="container">
			<div class="cols3">
				<img src="<?=$g4['path']?>/layout/images/ex_w300.jpg" alt="Pension" />
				<h5>스파,복층,바닷가,커플</h5>
				<h3>[강원 강릉] 경포 그곳에 가면</h3>
				<h4>56,000원</h4>
			</div>
		...
		<div class="container">
			...
			<div class="cols2">
				...
				<div class="section-group">
					<div class="left">
						<img src="<?=$g4['path']?>/layout/images/ex_w270.jpg" alt="Pension" />
					</div>
					<div class="right">
						<h1>1</h1>
						<h5>스파,복층,바닷가,커플</h5>
		...
		<div class="container">
			...
			<div class="latest">
				<div>
					...
					<div class="contents">
						<ul>
							<li>공지하나 공지하나 공지하나 공지하나 공지하나 공지</li>
							<li>공지둘</li>
							<li>공지셋</li>
							<li>공지넷</li>
						</ul>
