...
<!-- 갤러리 -->
		...
		<div class="gp-slider">
			<!-- 원본이미지 -->
			<ul id="slider1">
				<li><img src="http://showmotel.cdn2.cafe24.com/room13/1.jpg" alt="" /></li>
				<li><img src="http://showmotel.cdn2.cafe24.com/room13/2.jpg" alt="" /></li>
				<li><img src="http://showmotel.cdn2.cafe24.com/room13/3.jpg" alt="" /></li>
			</ul>

			<!-- 썸네일이미지 -->
			<ul id="slider1-pager">
				<li><a data-slide-index="0" href=""><img src="http://showmotel.cdn2.cafe24.com/room13/1.jpg" width=60 height=40 alt="" /></a></li>
				<li><a data-slide-index="1" href=""><img src="http://showmotel.cdn2.cafe24.com/room13/2.jpg" width=60 height=40 alt="" /></a></li>
				<li><a data-slide-index="2" href=""><img src="http://showmotel.cdn2.cafe24.com/room13/3.jpg" width=60 height=40 alt="" /></a></li>
			</ul>
