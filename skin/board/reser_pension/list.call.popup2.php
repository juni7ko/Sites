...
echo "<dt style='font-weight:bold; font-size:13px; color:#000000; margin-bottom:15px;'>{$py}-{$pm}-{$pd} 예약현황(숙박기간)</dt>";
...
for ($r_info_cnt=0; $r_info = sql_fetch_array($result); $r_info_cnt++)  {
	echo Get_Date_Reserv_List_Pop($bo_table, $r_info[r_info_name], $rc_date);
}
?>
<br style="clear:both;">
