...
if($is_admin) {
	...
	if($rResult == "0020") { // 예약완료
		$en_msg1 = urlencode("예약완료:{$write[wr_name]}{$write[wr_link1]} {$write[ca_name]}, http://staystore.co.kr");
	} else if($rResult == "0030") { // 예약취소
		//$en_msg1 = urlencode("예약이 취소되었습니다. 재 예약을 원하시면 전화주세요. http://staystore.co.kr");
	}
