...
//	$msender = "01096968112";
	...
	if($g4['bank']){
		...
		$bank = "농협 352-0621-4814-63 송창규";
	}

	//$en_msg1 = urlencode("예약번호:".$wr_3."/금액:".$wr_10."/농협:000-11-123456 주인");
	//$en_msg1 = urlencode("예약No:".$wr_3." 금액:".$wr_10."/농협 352-0621-4814-63 송창규 http://gyungpopension.co.kr");
	$en_msg1 = urlencode("예약No:".$wr_3." 금액:".$wr_10." ".$bank." http://gyungpopension.co.kr");
