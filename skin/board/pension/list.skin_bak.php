...
?>
    ...
    <td align=left style='word-break:break-all; padding-top:15px; padding-bottom:15px;'> 
		...
		<?php $style = "";
		             ...
		             echo "</a></strong>";
			?></font></td>
		<td  style="padding-right: 10px"><font color=#777777><?=cut_str(strip_tags($list[$i][wr_content]),210,"…")?></font></td>
...
/*?><td width=40><span style='font:normal 11px tahoma; color:#BABABA;'><?=$list[$i][last2]?></span></td><?*/?>
        <?php if ($is_good) { ?><td align="center" width=40><span style='font:normal 11px tahoma; color:#BABABA;'><?=$list[$i][wr_good]?></span></td><?php } ?>
        <?php if ($is_nogood) { ?><td align="center" width=40><span style='font:normal 11px tahoma; color:#BABABA;'><?=$list[$i][wr_nogood]?></span></td><?php } ?>
        </tr>
    ...
    <tr><td colspan=<?=$colspan?> height=1 bgcolor=ededed>
</table>
</form>
