...
<script type="text/javascript">
	...
	function pageLoader(uri,sDatei) {
		$.ajax({
			url : uri,
			type : "post",
			data : {
	...
	$(document).ready(function() {
		...
		pageLoader("<?=$board_skin_path?>/view.skin.ajax.php",sDatei);
	});
...
<div class="resCalArea">
<!-- 달력 로딩하기 -->
<div class="ajLoadCal">
<?php //include_once("view.skin.ajax.php"); ?>
</div>
<iframe width=0 height=0 name='calHidden' style='display:none;'></iframe>
<form id="formLoadReser" nane="formLoadReser" method="post" onsubmit="return fwrite_submit(this);" enctype="multipart/form-data" style="margin:0px;">
<div id="loadReserDate">
