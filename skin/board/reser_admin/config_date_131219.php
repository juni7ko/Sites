...
<tr class="list<?=$rlist?> ht center">
	...
	<td><input type=button class='<?=$css[btn]?>' value="수정" onClick="Process('edit',<?=$r_date[r_date_idx]?>); return false;">
		<input type=button class='<?=$css[btn]?>' value="삭제" onClick="Process('del',<?=$r_date[r_date_idx]?>); return false;">
        <input type=button class='<?=$css[btn]?>' value="복사" onClick="Process('copy',<?=$r_date[r_date_idx]?>); return false;"></td>
</tr>
