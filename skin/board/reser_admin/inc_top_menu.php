...
<div class="ui-state-default ui-corner-all" style="margin:5px 0; padding: 5px .7em; text-align:right;">
    ...
    <a href='<?=$g4[bbs_path]?>/resList.php?bo_table=<?=$bo_table?>&view_mode=list&pension_id=<?=$pension_id?>'>리스트</a><a href="<?=$g4[bbs_path]?>/board.php?bo_table=<?=$bo_table?>&view_mode=call&pension_id=<?=$pension_id?>">(달력)</a> |
