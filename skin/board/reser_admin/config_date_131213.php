...
<tbody>
<?php for ($i=0; $r_date = sql_fetch_array($result); $i++)  {
	$j = $i+1;
	$rlist = $i%2;
?>
<tr>
	...
	<td>
		<button type="button" class="btn btn-sm btn-info" onClick="Process('edit',<?=$r_date[r_date_idx]?>); return false;">수정</button>
		<button type="button" class="btn btn-sm btn-danger" onClick="Process('del',<?=$r_date[r_date_idx]?>); return false;">삭제</button>
...
<div style='margin-top:5px; text-align:right;'><button type="button" class="btn btn-sm btn-info" onClick="Process('add',<?=$pension_id?>); return false;">추가</button></div>
<?php
## 리스트 끝
}
?>
...
<tr class="ht center list<?=$rlist?>">
	<td class="<?=$css[td]?>"><input type=hidden name=r_info_id[] value="<?=$r_info[r_info_id]?>"><?=$r_info[r_info_name]?></td>
    <td><input type=input size=7 name=r_date_cost_1[]></td>
    <td><input type=input size=7 name=r_date_cost_2[]></td>
    <td><input type=input size=7 name=r_date_cost_3[]></td>
    <td><input type=input size=7 name=r_date_cost_4[]></td>
    <td><input type=input size=7 name=r_date_cost_5[]></td>
</tr>
<tr class="ht center list<?=$rlist?>">
	<td class="<?=$css[td]?>">할인율</td>
    <td><input type=input size=7 name=r_date_cost_11[]></td>
    <td><input type=input size=7 name=r_date_cost_12[]></td>
    <td><input type=input size=7 name=r_date_cost_13[]></td>
    <td><input type=input size=7 name=r_date_cost_14[]></td>
    <td><input type=input size=7 name=r_date_cost_15[]></td>
</tr>
<?php }
...
?>
<tr class="ht center list<?=$rlist?>">
	<td class="<?=$css[td]?>"><input type=hidden name=r_dcost_idx[] value="<?=$date_cost[r_dcost_idx]?>"><input type=hidden name=r_info_id[] value="<?=$r_info[r_info_id]?>"><?=$r_info[r_info_name]?></td>
    <td><input type=input size=7 name=r_date_cost_1[] value="<?=$date_cost[r_date_cost_1]?>"></td>
    <td><input type=input size=7 name=r_date_cost_2[] value="<?=$date_cost[r_date_cost_2]?>"></td>
    <td><input type=input size=7 name=r_date_cost_3[] value="<?=$date_cost[r_date_cost_3]?>"></td>
    <td><input type=input size=7 name=r_date_cost_4[] value="<?=$date_cost[r_date_cost_4]?>"></td>
    <td><input type=input size=7 name=r_date_cost_5[] value="<?=$date_cost[r_date_cost_5]?>"></td>
</tr>
<tr class="ht center list<?=$rlist?>">
	<td class="<?=$css[td]?>">할인율</td>
    <td><input type=input size=7 name=r_date_cost_11[] value="<?=$date_cost[r_date_cost_11]?>"></td>
    <td><input type=input size=7 name=r_date_cost_12[] value="<?=$date_cost[r_date_cost_12]?>"></td>
    <td><input type=input size=7 name=r_date_cost_13[] value="<?=$date_cost[r_date_cost_13]?>"></td>
    <td><input type=input size=7 name=r_date_cost_14[] value="<?=$date_cost[r_date_cost_14]?>"></td>
    <td><input type=input size=7 name=r_date_cost_15[] value="<?=$date_cost[r_date_cost_15]?>"></td>
</tr>
<tr class="ht center list<?=$rlist?>">
	<td class="<?=$css[td]?>">할인가격</td>
...
## 업데이트 리스트 끝
	...
	if($u == "del") {
		...
		for($i=0; $i < count($r_dcost_idx); $i++ ) {
			...
			if($r_date_cost_12[$i]) $r_date_cost_22 = round( $r_date_cost_2[$i] - ($r_date_cost_2[$i] * ($r_date_cost_12[$i] * 0.01)), -2 );
				else $r_date_cost_22 = $r_date_cost_2[$i];
			if($r_date_cost_13[$i]) $r_date_cost_23 = round( $r_date_cost_3[$i] - ($r_date_cost_3[$i] * ($r_date_cost_13[$i] * 0.01)), -2 );
				else $r_date_cost_23 = $r_date_cost_3[$i];
			if($r_date_cost_14[$i]) $r_date_cost_24 = round( $r_date_cost_4[$i] - ($r_date_cost_4[$i] * ($r_date_cost_14[$i] * 0.01)), -2 );
				else $r_date_cost_24 = $r_date_cost_4[$i];
			...
			if($r_dcost_idx[$i]) {
				$sql = "UPDATE {$write_table}_r_date_cost SET
					...
					r_date_cost_21 = '$r_date_cost_21',
					r_date_cost_22 = '$r_date_cost_22',
					r_date_cost_23 = '$r_date_cost_23',
					r_date_cost_24 = '$r_date_cost_24',
					r_date_cost_25 = '$r_date_cost_25'
