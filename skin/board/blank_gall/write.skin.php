...
.field { border:solid 1px <?=$brd_line_color?>; }
</style>
...
<div style="border:solid 1px <?=$brd_line_color?>; height:34px;">
...
<tr>
    ...
    <td class=write_td><input type='text' class='ed' size=50 name='wr_link<?=$i?>' itemname='링크 #<?=$i?>' value='<?=$write["wr_link{$i}"]?>'></td>
</tr>
<tr><td colspan=2 height=1 bgcolor="<?=$brd_line_color?>"></td></tr>
<?php } ?>
<?php } ?>
...
<tr>
    ...
    <td class=write_td style='padding:5 0 5 0;'><table id="variableFiles" cellpadding=0 cellspacing=0></table><?php
// print_r2($file); ?>
        <script language="JavaScript">
        var flen = 0;
...
<tr>
    ...
    <td class=write_td><input class='ed' size=50 name=wr_trackback itemname="트랙백" value="<?=$trackback?>">
