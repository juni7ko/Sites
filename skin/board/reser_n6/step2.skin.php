...
<script type="text/javascript">
  ...
  <tr>
    ...
    <td bgcolor="#f3f3f3">:&nbsp;<input type="text" name=wr_link2 id="wr_link2" required value="<?=$t_date?>" size="10" maxlength="8"/>	 퇴실일자를 선택해 주세요!!</td>
	</tr>
<!--
  <tr>
    <td align="center" bgcolor="#f3f3f3">퇴실일자</td>
...
?>
  ...
  <tr>
    ...
    <td>예약신청 후 숙박료가 입금확인되어야 예약신청이 완료됩니다. <br />
    	예약신청 후 <span style="color:#F00;">3시간이내 숙박료를 입금</span>하지 않으면 신청내역이 삭제됩니다.<br />
      <span style="color:#F00;">올바른 예약문화 정착을 위하여 예약취소시 환불수수료가 있습니다. 꼭 확인하시고 예약해주세요!</span></td>
  </tr>
</table>
