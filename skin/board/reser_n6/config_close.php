...
<?php if($u == "add") {
	...
	echo "<td>".Get_Room_Select($pen_id,'r_close_name','')."</td>";
	...
	echo "<td><input type=button class='$css[btn]' value=\"추가\" onClick=\"Process('insert',0); return false;\"> <input type=button class='$css[btn]' value=\"취소\" onClick=\"history.back(-1); return false;\"></td>";
	echo "</tr>";
	echo "</table>";
} else if($u == "edit") {
	$colspan = 4;
