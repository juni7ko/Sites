...
<form name="fregister" method="POST" onsubmit="return fregister_submit(this);" autocomplete="off">
	...
	<table width=600 cellspacing=0 cellspacing=0 align=center><tr><td align=center>
		...
		<div style="margin:10px 0;">
			<input type="radio" name="utype" value='user' id="agree30" checked />&nbsp;<label for="agree30">일반회원 가입</label>
			&nbsp; <input type="radio" name="utype" value='padmin' id="agree31" />&nbsp;<label for="agree31">펜션관리자 가입</label>
		</div>
