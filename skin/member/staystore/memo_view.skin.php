    ...
    <td height="200" align="center" valign="top">
        ...
        <tr> 
            <td height="40" align=right>
                <?php echo "<a href=\"$prev_link\"><img src='$member_skin_path/img/btn_memo_prev.gif' border='0'></a>&nbsp;&nbsp;";
...
<tr>
    <td height="40" align="center" valign="bottom">
        <?php if ($kind == "recv") echo "<a href='./memo_form.php?me_recv_mb_id=$mb[mb_id]&me_id=$memo[me_id]'><img src='$g4[bbs_img_path]/btn_reply.gif' border='0'></a>&nbsp;&nbsp;"; ?>
