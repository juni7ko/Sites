    ...
    <td>
        ...
        <tr>
            ...
            <td height="20" style="text-align:justify;"><font color="#848484"><?=$po[po_subject]?></font>
                <?php if ($is_admin == "super") { ?><a href="<?=$g4[admin_path]?>/poll_form.php?w=u&po_id=<?=$po_id?>"><img src="<?=$poll_skin_path?>/img/admin.gif" width="33" height="15" border=0 align=absmiddle></a></center><?php } ?>
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td colspan=2>
                ...
                <tr>
                    <td width="25" align="center"><?php if ($i == 1) { echo "<img src='$poll_skin_path/img/a.gif' width='12' height='13'>"; } else { echo "&nbsp;"; } ?></td>
