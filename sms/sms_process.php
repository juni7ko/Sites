...
<?php
	...
	* 작성일자:2012년 11월 20일
	* 작성목적: 본 프로그램은 통큰아이 sms 문자메세지에서 php 웹프로그램 관련 예제이다.
	*              본 예제에서는 보내는 사람의 핸드폰번호, 받는사람 핸드폰번호,전송내용 sms_main.php에서
	*              전송 받아 실제 sms 보내는 모듈입니다..
	*              본 프로그램을 실행하려면 웹서버에 본 프로그램과 sms_process.php,nusoap_tong.php
	*              파일을 업로드하고 sms_process.php 파일에 통큰아이에서 생성하신 sms 아이디와 패스워드를
	*              입력하면 됩니다.
	*/
	...
	/*콜백 예약 전송으로 구성하실경우*/
	//$result=$sms->SendSMSCallBackReserve($sms_id,$sms_pwd,$snd_number,$rcv_number,$callbackURL,$sms_content,$reserve_date,$reserve_time,$userdefine);// 10개의 인자로 함수를 호출합니다.
