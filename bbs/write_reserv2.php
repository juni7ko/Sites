...
if (!$bo_table)
    alert("bo_table 값이 넘어오지 않았습니다.\\n\\nwrite_reserv.php?bo_table=code 와 같은 방식으로 넘겨 주세요.", $g4[path]);

@include_once ("$g4[path]/skin/board/write_reserv.head.skin.php");
@include_once ("$board_skin_path/write_reserv.head.skin.php");
...
//--------------------------------------------------------------------------
include_once ("$board_skin_path/write_reserv2.skin.php");
...
@include_once ("$board_skin_path/write_reserv.tail.skin.php");
?>
