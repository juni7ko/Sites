...
<tr class='ht'>
    ...
    <td>
        ...
        <?php if ($w=='u') { ?><a href="javascript:location.href='./board_list.php?sfl=a.gr_id&stx='+document.fboardform.gr_id.value;">동일그룹게시판목록</a><?php }?></td>
</tr>
<tr class='ht'>
    <td></td>
    <td>게시판 제목</td>
...
<p align=center>
    ...
    <?php if ($w == 'u') { ?><input type=button class=btn1 value='  복  사  ' onclick="board_copy('<?=$bo_table?>');"><?php }?>
</form>
