...
<tr class='ht'>
    <td>아이디</td>
    <td>
        <input type=text class=ed name='mb_id' size=20 maxlength=20 minlength=2 <?=$required_mb_id?> itemname='아이디' value='<?php echo $mb[mb_id] ?>'>
        <?php if ($w=="u"){?><a href='./boardgroupmember_form.php?mb_id=<?=$mb[mb_id]?>'>접근가능그룹보기</a><?php }?>
    </td>
    <td>패스워드</td>
...
<tr class='ht'>
    <td>이름(실명)</td>
    <td><input type=text class=ed name='mb_name' maxlength=20 minlength=2 required itemname='이름(실명)' value='<?php echo $mb[mb_name] ?>'></td>
    <td>별명</td>
    <td><input type=text class=ed name='mb_nick' maxlength=20 minlength=2 required itemname='별명' value='<?php echo $mb[mb_nick] ?>'></td>
</tr>
<tr class='ht'>
    <td>회원 권한</td>
    <td>
...
<tr class='ht'>
    <td>E-mail</td>
    <td><input type=text class=ed name='mb_email' size=40 maxlength=100 required email itemname='e-mail' value='<?php echo $mb[mb_email] ?>'></td>
    <td>홈페이지</td>
    <td><input type=text class=ed name='mb_homepage' size=40 maxlength=255 itemname='홈페이지' value='<?php echo $mb[mb_homepage] ?>'></td>
</tr>
<tr class='ht'>
    <td>전화번호</td>
    <td><input type=text class=ed name='mb_tel' maxlength=20 itemname='전화번호' value='<?php echo $mb[mb_tel] ?>'></td>
    <td>핸드폰번호</td>
    <td><input type=text class=ed name='mb_hp' maxlength=20 itemname='핸드폰번호' value='<?php echo $mb[mb_hp] ?>'></td>
</tr>
<tr class='ht'>
    <td>주소</td>
    <td>
        ...
        <br><input type=text class=ed name='mb_addr2' size=25 itemname='상세주소' value='<?php echo $mb[mb_addr2] ?>'> 상세주소 입력</td>
    <td>회원아이콘</td>
    <td colspan=3>
        <input type=file name='mb_icon' class=ed><br>이미지 크기는 <?=$config[cf_member_icon_width]?>x<?=$config[cf_member_icon_height]?>으로 해주세요.
        <?php $mb_dir = substr($mb[mb_id],0,2);
...
<tr class='ht'>
    <td>생년월일</td>
    <td><input type=text class=ed name=mb_birth size=9 maxlength=8 value='<?php echo $mb[mb_birth] ?>'></td>
    <td>남녀</td>
    <td>
...
<tr class='ht'>
    <td>서명</td>
    <td><textarea class=ed name=mb_signature rows=5 style='width:99%; word-break:break-all;'><?php echo $mb[mb_signature] ?></textarea></td>
    <td>자기 소개</td>
    <td><textarea class=ed name=mb_profile rows=5 style='width:99%; word-break:break-all;'><?php echo $mb[mb_profile] ?></textarea></td>
</tr>
<tr class='ht'>
    <td>메모</td>
    <td colspan=3><textarea class=ed name=mb_memo rows=5 style='width:99%; word-break:break-all;'><?php echo $mb[mb_memo] ?></textarea></td>
</tr>
...
<tr class='ht'>
    <td>탈퇴일자</td>
    <td><input type=text class=ed name=mb_leave_date size=9 maxlength=8 value='<?php echo $mb[mb_leave_date] ?>'></td>
    <td>접근차단일자</td>
