...
// 게시판 그룹 관리자 지정
$groupSql = " SELECT gr_id, gr_admin FROM g4_group WHERE gr_id = 'pen_{$_POST['mb_1']}' and gr_admin != '$mb_id' LIMIT 1 ";
if(sql_fetch($groupSql)) {
    sql_query(" UPDATE g4_group set gr_admin = '$mb_id' WHERE gr_id = 'pen_{$_POST['mb_1']}' ");
}
