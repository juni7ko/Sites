...
<tr class='ht'>
    <td colspan=4 align=left><?=subtitle("펜션정보")?></td>
</tr>
<tr><td colspan=4 class=line1></td></tr>
...
<tr class='ht'>
	...
	<table class="table-form">
		...
		<tr>
			<th width="20%"><input type='text' name='cf_<?php echo $i?>_subj' size='15' class='iText' value='<?php echo get_text($config["cf_{$i}_subj"])?>' title='여분필드 <?php echo $i?> 제목' style='text-align:right;font-weight:bold;' /></th>
			<td width="30%"><input type='text' name='cf_<?php echo $i?>' class='iText w90' value='<?php echo $config["cf_$i"]?>' title='여분필드 <?php echo $i?> 설정값' /></td>
			<th width="20%"><input type='text' name='cf_<?php echo $k?>_subj' size='15' class='iText' value='<?php echo get_text($config["cf_{$k}_subj"])?>' title='여분필드 <?php echo $k?> 제목' style='text-align:right;font-weight:bold;' /></th>
