...
if($member[mb_level] == 5 && $member[mb_1]) {
	goto_url("./pen/");
} else {
	$new_member_rows = 5;
	$new_point_rows = 5;
	...
	<table width=100%>
		<tr>
			<td width=50% align=left>
				(총회원수 : <?=number_format($total_count)?>, <font color=orange>차단 : <?=number_format($intercept_count)?></font>, <font color=crimson>탈퇴 : <?=number_format($leave_count)?></font>)</td>
