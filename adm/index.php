...
//=$listall?> (총회원수 : <?=number_format($total_count)?>, <font color=orange>차단 : <?=number_format($intercept_count)?></font>, <font color=crimson>탈퇴 : <?=number_format($leave_count)?></font>)</td>
...
<tr><td colspan='<?=$colspan?>' class='line2'></td></tr>
<?php $sql = " select a.*, b.bo_subject, c.gr_subject, c.gr_id
          $sql_common
          $sql_order
...
<?php $sql_common = " from $g4[point_table] ";
$sql_search = " where (1) ";
