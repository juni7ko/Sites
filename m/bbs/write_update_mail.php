            ...
            <td>
                <table width="500" border="0" cellspacing="0" cellpadding="4">
                            <tr> 
                                ...
                                <td width="90%" bgcolor=#FBF7E7><?php echo $wr_subject?></td>
                            </tr>
                            <tr bgcolor="#FFFFFF"> 
                            ...
                            <tr> 
                                ...
                                <td bgcolor=#FBF7E7><?php echo $wr_name?></td>
                            </tr>
                        </table>
                <p>

                <table width="500" border="0" align="center" cellpadding="4" cellspacing="0">
                <tr><td height="150" style="word-break:break-all;"><?php echo $wr_content?></td></tr>
                </table>
                <p>
                        ...
                        <table width="500" border="0" cellpadding="0" cellspacing="0" style="table-layout:fixed">
                            ...
                            <tr> 
                                <td height="25" bgcolor="#EDEDED" align="center">홈페이지에서도 게시물을 확인하실 수 있습니다.[<a href='<?php echo $link_url?>'>바로가기</a>]</td>
                            </tr>
                        </table>
            </td>
        </tr>
