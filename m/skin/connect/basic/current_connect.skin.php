...
<tr> 
    <td width="4" height="33" bgcolor="#7BB2D6"><img src="<?php echo $connect_skin_path?>/img/list_top_01.gif" width="4" height="33"></td>
    <td width="60" align="center" bgcolor="#7BB2D6"><font class=n_title1><strong>번호</strong></font></td>
    <td width="5" align="center" valign="middle" bgcolor="#7BB2D6"><img src="<?php echo $connect_skin_path?>/img/list_top_02.gif" width="5" height="33"></td>
    <td width="5" align="center" valign="middle" bgcolor="#EEEEEE"><img src="<?php echo $connect_skin_path?>/img/list_top_03.gif" width="5" height="33"></td>
    ...
    <td width="4" bgcolor="#EEEEEE"><img src="<?php echo $connect_skin_path?>/img/list_top_04.gif" width="4" height="33"></td>
</tr>
<?php
