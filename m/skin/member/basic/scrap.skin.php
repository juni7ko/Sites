            ...
            <td width="540" bgcolor="#FFFFFF">
                ...
                <?php for ($i = 0; $i < count($list); $i++) { ?>
                    <tr height=25 bgcolor="#F6F6F6" align="center"> 
                        ...
                        <td><a href="javascript:del('<?php echo $list[$i][del_href]?>');"><img src="<?php echo $member_skin_path?>/img/btn_comment_delete.gif" width="45" height="14" border="0"></a></td>
                    </tr>
                <?php } ?>

                <?php if ($i == 0) echo "<tr><td colspan=5 align=center height=100>자료가 없습니다.</td></tr>"; ?>
                </table></td>
        </tr>
        </table></td>
</tr>
<tr> 
    <td height="30" align="center"><?php echo get_paging($config['cf_m_write_pages'], $page, $total_page, "?$qstr&page=");?></td>
</tr>
<tr> 
...
<tr>
    <td height="40" align="center" valign="bottom"><a href="javascript:window.close();"><img src="<?php echo $member_skin_path?>/img/btn_close.gif" width="48" height="20" border="0"></a></td>
</tr>
</table>
<br>
