            ...
            <tr> 
                <td width="540" height="2" align="center" valign="top" bgcolor="#FFFFFF"><table width="540" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                            ...
                            <td width="10" valign="bottom"><img src="<?php echo $member_skin_path?>/img/l.gif" width="1" height="8"></td>
                            <td width="450" style='word-break:break-all;'><?php echo get_text(cut_str($write['wr_subject'], 255))?></td>
                        </tr>
                        <tr> 
...
<tr>
    <td height="40" align="center" valign="bottom"><INPUT type=image width="40" height="20" src="<?php echo $member_skin_path?>/img/ok_btn.gif" border=0></td>
</tr>
</form>
</table>
