...
<table width=600 cellspacing=0 cellspacing=0 align=center><tr><td align=center>
    ...
    <tr> 
        <td align=center><img src="<?php echo $member_skin_path?>/img/join_title.gif" width="624" height="72"></td>
    </tr>
    </table>

    <?php if ($config['cf_use_jumin']) { // 주민등록번호를 사용한다면 ?>
    ...
    <table width="100%" cellpadding="4" cellspacing="0" bgcolor=#EEEEEE>
        ...
        <tr> 
            <td align="center" valign="top"><textarea style="width: 98%" rows=10 readonly class=ed><?php echo get_text($config['cf_stipulation'])?></textarea></td>
        </tr>
        <tr> 
            <td height=40>
    ...
    <table width="100%" cellpadding="4" cellspacing="0" bgcolor=#EEEEEE>
        ...
        <tr> 
            <td align="center" valign="top"><textarea style="width: 98%" rows=10 readonly class=ed><?php echo get_text($config['cf_privacy'])?></textarea></td>
        </tr>
        <tr> 
            <td height=40>
...
<br>
<div align=center>
<input type=image width="66" height="20" src="<?php echo $member_skin_path?>/img/join_ok_btn.gif" border=0>
</div>
