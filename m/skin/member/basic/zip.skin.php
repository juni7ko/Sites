    ...
    <td colspan="2">
        ...
        <tr> 
            <td align="center" valign="middle" bgcolor="#EBEBEB">
                ...
                <tr> 
                    <td width="5%" align="center" bgcolor="#FFFFFF" ><img src="<?php echo $g4['bbs_img_path']?>/icon_01.gif" width="5" height="5"></td>
                    <td width="35%" align="left" bgcolor="#FFFFFF" ><font color="#666666"><b><?php echo $g4['title']?></b></font></td>
...
<tr> 
    <td height="70" colspan="2" valign="bottom"><img src="<?php echo $g4['bbs_img_path']?>/zip_img_01.gif" width="273" height="40"></td>
</tr>
<tr> 
    <td height="20" colspan="2"></td>
</tr>
<tr> 
    <td width=130><img src="<?php echo $g4['bbs_img_path']?>/zip_img_02.gif" width="125" height="14"></td>
    <td><input type=text name=addr1 value='<?php echo $addr1?>' required minlength=2 itemname='동(읍/면/리)' size=35> <input type=image src='<?php echo $g4['bbs_img_path']?>/btn_post_search.gif' border=0 align=absmiddle></td>
</tr>
<tr> 
    <td height="20" colspan="2"></td>
</tr>
...
<table width="600" border="0" cellspacing="0" cellpadding="0">
<tr> 
    <td height="1" colspan="2" background="<?php echo $g4['bbs_img_path']?>/post_dot_bg.gif"></td>
</tr>
<tr> 
    <td height="50" colspan="2"><img src="<?php echo $g4['bbs_img_path']?>/zip_img_03.gif" width="99" height="13"></td>
</tr>
<tr> 
    <td width="10%"></td>
    <td width="90%">
        ...
        <tr>
            <td height=23 valign=top>총 <?php echo $search_count?>건 가나다순</td>
        </tr>
