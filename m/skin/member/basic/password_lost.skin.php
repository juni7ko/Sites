    ...
    <tr>
        <td height="50" align="center" valign="middle" bgcolor="#EBEBEB"><table width="590" height="40" border="0" cellspacing="0" cellpadding="0">
            <tr> 
                ...
                <td width="175" align="left" bgcolor="#FFFFFF" ><font color="#666666"><b><?php echo $g4['title']?></b></font></td>
...
<tr> 
    <td height="170" align="center" valign="middle" background="<?php echo $member_skin_path?>/img/gray_bg_img.gif" bgcolor="#FFFFFF">
...
<tr> 
    <td height="40" align="center" valign="bottom"><input type="image" src="<?php echo $member_skin_path?>/img/btn_next_01.gif">&nbsp;&nbsp;<a href="javascript:window.close();"><img src="<?php echo $member_skin_path?>/img/btn_close.gif" width="48" height="20" border="0"></a></td>
</tr>
</table>
</form>
