...
<script>
var member_skin_path = "<?php echo $member_skin_path?>";
</script>
<script type="text/javascript" src="<?php echo $member_skin_path?>/ajax_register_form.jquery.js"></script>
...
<tr>
    <td><img src="<?php echo $member_skin_path?>/img/join_form_title.gif" width="624" height="72">
...
<tr>
    <td bgcolor="#CCCCCC">
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding><INPUT class=ed type=password name="mb_password" size=20 maxlength=20 <?php echo ($w=="")?"required":"";?> itemname="패스워드"></TD>
        </TR>
        <TR bgcolor="#FFFFFF">
            <TD class=m_title>패스워드 확인</TD>
            <TD class=m_padding><INPUT class=ed type=password name="mb_password_re" size=20 maxlength=20 <?php echo ($w=="")?"required":"";?> itemname="패스워드 확인"></TD>
        </TR>
        <!-- <TR bgcolor="#FFFFFF">
...
<tr>
    <td bgcolor="#CCCCCC">
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding>
                <input name=mb_name itemname="이름" value="<?php echo $member['mb_name']?>" <?php echo $member['mb_name']?"readonly class=ed2":"class=ed";?>> 
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class='m_padding lh'>
                ...
                <br>별명을 바꾸시면 앞으로 <?php echo (int)$config['cf_nick_modify']?>일 이내에는 변경 할 수 없습니다.
            </TD>
        </TR>
        <?php } else { ?>
        <input type=hidden name="mb_nick_default" value='<?php echo $member['mb_nick']?>'>
        ...
        <?php if ($w=="") { ?>
            <TR bgcolor="#FFFFFF">
                ...
                <TD class=m_padding><input class=ed type=text id=mb_birth name='mb_birth' size=8 maxlength=8 minlength=8 required numeric itemname='생년월일' value='<?php echo $member['mb_birth']?>' readonly title='옆의 달력 아이콘을 클릭하여 날짜를 입력하세요.'></TD>
            </TR>
        <?php } ?>
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding><input class=ed type=text name='mb_homepage' size=38 maxlength=255 <?php echo $config['cf_req_homepage']?'required':'';?> itemname='홈페이지' value='<?php echo $member['mb_homepage']?>'></TD>
        </TR>
        <?php } ?>
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding><input class=ed type=text name='mb_tel' size=21 maxlength=20 <?php echo $config['cf_req_tel']?'required':'';?> itemname='전화번호' value='<?php echo $member['mb_tel']?>'></TD>
        </TR>
        <?php } ?>
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding><input class=ed type=text name='mb_hp' size=21 maxlength=20 <?php echo $config['cf_req_hp']?'required':'';?> itemname='핸드폰번호' value='<?php echo $member['mb_hp']?>'></TD>
        </TR>
        <?php } ?>
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD valign="middle" class=m_padding>
                ...
                <tr>
                    <td height="25"><input class=ed type=text name='mb_zip1' size=4 maxlength=3 readonly <?php echo $config['cf_req_addr']?'required':'';?> itemname='우편번호 앞자리' value='<?php echo $member['mb_zip1']?>'>
                         - 
                        <input class=ed type=text name='mb_zip2' size=4 maxlength=3 readonly <?php echo $config['cf_req_addr']?'required':'';?> itemname='우편번호 뒷자리' value='<?php echo $member['mb_zip2']?>'>
                        &nbsp;<a href="javascript:;" onclick="win_zip('fregisterform', 'mb_zip1', 'mb_zip2', 'mb_addr1', 'mb_addr2');"><img width="91" height="20" src="<?php echo $member_skin_path?>/img/post_search_btn.gif" border=0 align=absmiddle></a></td>
                </tr>
                <tr>
                    <td height="25" colspan="2"><input class=ed type=text name='mb_addr1' size=60 readonly <?php echo $config['cf_req_addr']?'required':'';?> itemname='주소' value='<?php echo $member['mb_addr1']?>'></td>
                </tr>
                <tr>
                    <td height="25" colspan="2"><input class=ed type=text name='mb_addr2' size=60 <?php echo $config['cf_req_addr']?'required':'';?> itemname='상세주소' value='<?php echo $member['mb_addr2']?>'></td>
                </tr>
                </table>
            </TD>
        </TR>
...
<tr>
    <td bgcolor="#CCCCCC">
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding><textarea name=mb_signature class=tx rows=3 style='width:95%;' <?php echo $config['cf_req_signature']?'required':'';?> itemname='서명'><?php echo $member['mb_signature']?></textarea></TD>
        </TR>
        <?php } ?>
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding><textarea name=mb_profile class=tx rows=3 style='width:95%;' <?php echo $config['cf_req_profile']?'required':'';?> itemname='자기 소개'><?php echo $member['mb_profile']?></textarea></TD>
        </TR>
        <?php } ?>
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding><input type=checkbox name=mb_mailling value='1' <?php echo ($w=='' || $member['mb_mailling'])?'checked':'';?>>정보 메일을 받겠습니다.</TD>
        </TR>
        <TR bgcolor="#FFFFFF">
            <TD width="160" class=m_title>SMS 수신여부</TD>
            <TD class=m_padding><input type=checkbox name=mb_sms value='1' <?php echo ($w=='' || $member['mb_sms'])?'checked':'';?>>핸드폰 문자메세지를 받겠습니다.</TD>
        </TR>
        ...
        <TR bgcolor="#FFFFFF"> 
            ...
            <TD class=m_padding><input type=checkbox name=mb_open value='1' <?php echo ($w=='' || $member['mb_open'])?'checked':'';?>>다른분들이 나의 정보를 볼 수 있도록 합니다. 
                <br>&nbsp;&nbsp;&nbsp;&nbsp; 정보공개를 바꾸시면 앞으로 <?php echo (int)$config['cf_open_modify']?>일 이내에는 변경이 안됩니다.</td> 
        </TR> 
        <?php } else { ?> 
...
<p align=center>
    <INPUT type=image width="66" height="20" src="<?php echo $member_skin_path?>/img/join_ok_btn.gif" border=0 accesskey='s'>
...
function fregisterform_submit(f) 
{
    ...
    */
    ...
    set_cookie("<?=md5($token)?>", "<?=base64_encode($token)?>", 1, "<?php echo $g4['cookie_domain']?>");
